...
export function EstoqueEntradaPage() {
  ...
  const medicamentoInputId = 'estoque-entrada-medicamento-input'
  const medicamentoListboxId = 'estoque-entrada-medicamento-listbox'
  const medicamentoErrorId = 'estoque-entrada-medicamento-error'
  const getMedicamentoOptionId = (id: number) => `estoque-entrada-medicamento-option-${id}`
